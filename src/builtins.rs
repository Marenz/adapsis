...
pub static BUILTINS: &[Builtin] = &[
    ...
    Builtin {
        name: "pop",
        aliases: &[],
        short: "remove last item, returns [new_list, item]",
        long: "Removes the last item from a List and returns a 2-element list [new_list, removed_item]. Errors if the list is empty.",
        category: BuiltinCategory::List,
    },
    Builtin {
        name: "remove",
        aliases: &[],
        short: "remove item at index, returns new list",
        long: "Returns a new List with the item at the given 0-based index removed. Errors if the index is out of bounds.",
        category: BuiltinCategory::List,
    },
    Builtin {
        name: "insert",
        aliases: &[],
        short: "insert item at index, returns new list",
        long: "Returns a new List with item inserted before the given 0-based index. Errors if the index is out of bounds.",
        category: BuiltinCategory::List,
    },
    Builtin {
        name: "reverse",
        ...
        long: "Returns a new List with items in reversed order. The original is not modified.",
        category: BuiltinCategory::List,
    },
    Builtin {
        name: "sort",
        aliases: &[],
        short: "sort a list (Int/Float/String only)",
        long: "Returns a new List sorted in ascending order. Only works on lists of Int, Float, or String. Errors for mixed or unsupported types.",
        category: BuiltinCategory::List,
    },
    Builtin {
        name: "slice",
        aliases: &[],
        short: "get sublist from start to end",
        long: "Returns a sublist from start (inclusive) to end (exclusive). Both indices are clamped to valid range.",
        category: BuiltinCategory::List,
    },
    // Map
    Builtin {
        name: "map",
        aliases: &[],
        short: "create empty map or map from key/value pairs",
        long: "Creates a Map from zero or more key/value pairs. `map()` returns empty map; `map(k1, v1, k2, v2)` creates a map with those entries. Preserves insertion order.",
        category: BuiltinCategory::Map,
    },
    Builtin {
        name: "map_set",
        aliases: &[],
        short: "returns new map with key set to value",
        long: "Returns a new Map with the given key set to value. If the key already exists, its value is replaced. Functional — does not modify the original.",
        category: BuiltinCategory::Map,
    },
    Builtin {
        name: "map_get",
        aliases: &[],
        short: "get value by key (optional default)",
        long: "Returns the value for a key in a Map. `map_get(m, key)` errors if not found. `map_get(m, key, default)` returns default instead.",
        category: BuiltinCategory::Map,
    },
    Builtin {
        name: "map_has",
        aliases: &[],
        short: "check if map has key",
        long: "Returns Bool indicating whether the Map contains the given key.",
        category: BuiltinCategory::Map,
    },
    Builtin {
        name: "map_remove",
        aliases: &[],
        short: "returns new map with key removed",
        long: "Returns a new Map with the given key (and its value) removed. If the key does not exist, returns the map unchanged.",
        category: BuiltinCategory::Map,
    },
    Builtin {
        name: "map_keys",
        aliases: &[],
        short: "get list of map keys",
        long: "Returns a List of all keys in the Map, in insertion order.",
        category: BuiltinCategory::Map,
    },
    Builtin {
        name: "map_values",
        aliases: &[],
        short: "get list of map values",
        long: "Returns a List of all values in the Map, in insertion order.",
        category: BuiltinCategory::Map,
    },
    Builtin {
        name: "map_entries",
        aliases: &[],
        short: "get list of [key, value] pairs",
        long: "Returns a List of 2-element lists, each being [key, value], in insertion order.",
        category: BuiltinCategory::Map,
    },
    // Set
    Builtin {
        name: "set",
        aliases: &[],
        short: "create empty set or set from items",
        long: "Creates a Set from zero or more values. `set()` returns empty set; `set(a, b, c)` creates a set with those items. Duplicates are removed, insertion order preserved.",
        category: BuiltinCategory::Set,
    },
    Builtin {
        name: "set_add",
        aliases: &[],
        short: "returns new set with item added",
        long: "Returns a new Set with item added. If item already exists, returns the set unchanged. Functional — does not modify the original.",
        category: BuiltinCategory::Set,
    },
    Builtin {
        name: "set_remove",
        aliases: &[],
        short: "returns new set with item removed",
        long: "Returns a new Set with item removed. If item does not exist, returns the set unchanged.",
        category: BuiltinCategory::Set,
    },
    Builtin {
        name: "set_has",
        aliases: &[],
        short: "check if set contains item",
        long: "Returns Bool indicating whether the Set contains the given item.",
        category: BuiltinCategory::Set,
    },
    Builtin {
        name: "set_to_list",
        aliases: &[],
        short: "convert set to list",
        long: "Returns a List containing all items of the Set, in insertion order.",
        category: BuiltinCategory::Set,
    },
    // State
    // Result
